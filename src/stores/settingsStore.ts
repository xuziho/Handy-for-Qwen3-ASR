...
const settingUpdaters: {
  ...
  asr_backend: (value) => commands.changeAsrBackendSetting(value as string),
  qwen_base_url: (value) => commands.changeQwenBaseUrlSetting(value as string),
  qwen_api_key: (value) => commands.changeQwenApiKeySetting(value as string),
  ...
  debug_log_full_post_process_prompt: (value) =>
    commands.changeDebugLogFullPostProcessPromptSetting(value as boolean),
  custom_words: (value) => commands.updateCustomWords(value as string[]),
  term_corrections: (value) =>
    commands.updateTermCorrections(value as TermCorrectionRule[]),
  ...
  post_process_include_term_corrections: (value) =>
    commands.changePostProcessIncludeTermCorrectionsSetting(value as boolean),
  post_process_term_corrections_prompt_template: (value) =>
    commands.changePostProcessTermCorrectionsPromptTemplateSetting(
      value as string,
    ),
  ...
  replace_sentence_period_with_space: (value) =>
    commands.changeReplaceSentencePeriodWithSpaceSetting(value as boolean),
  strip_language_markers: (value) =>
    commands.changeStripLanguageMarkersSetting(value as boolean),
